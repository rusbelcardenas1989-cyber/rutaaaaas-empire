        ...
        for y_coord in sorted(filas.keys()):
            ...
            for bbox, texto in bloques:
                ...
                if solo_num.isdigit() and len(solo_num) > 0:
                    ...
                    # Zona Centro (40% - 65%): Población
                    elif (ancho * 0.40) <= x_inicio <= (ancho * 0.65):
                        poblacion = val_num
                        
                    # Zona Derecha (66% - 100%): Edificios
                    elif x_inicio > (ancho * 0.65):
                        edificios = val_num
                else:
            ...
            if id_detectado is not None and edificios == 0:
                ...
                x_min = int(ancho * 0.68)  # Enfocarse exclusivamente en el bloque derecho final
